...
public class Appointment_adapter extends ArrayAdapter<Appointment_model> {
    ...
    private Appointment_adapter.OnItemClickListener listener;
    public void setOnItemClickListener(Appointment_adapter.OnItemClickListener listener) {
        this.listener = listener;
    }

    public Appointment_adapter(@NonNull Context context, int resource, ArrayList<Appointment_model> appointmentList) {
...
//        return super.getView(position, convertView, parent);
        ...
        Button accept = rowView.findViewById(R.id.btnapAccept);
        Button reject = rowView.findViewById(R.id.btnapReject);
        TextView number = rowView.findViewById(R.id.apcustomernumber);


        Appointment_model model= AppointmentList.get(position);
